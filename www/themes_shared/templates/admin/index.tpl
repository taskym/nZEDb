...
<ol style="list-style-type:decimal; line-height: 180%;">
	<li style="margin-bottom: 15px;">Configure your <a href="javascript:loadcontent('{$smarty.const.WWW_TOP}/site-edit.php')">site options</a>. The defaults will probably work fine.</li>
	<li style="margin-bottom: 15px;">There a default list of usenet groups provided. To get started, you will need to <a href="javascript:loadcontent('{$smarty.const.WWW_TOP}/group-list.php')">activate some groups</a>. <u>Do not</u> activate every group if its your first time setting this up. Try one or two first.
	You can also <a href="javascript:loadcontent('{$smarty.const.WWW_TOP}/group-edit.php')">add your own groups</a> manually.</li>
